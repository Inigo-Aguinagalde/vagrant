...
zona.com           IN      CNAME   ns.ZONA.COM.
www.zona.com       IN      CNAME   ns.ZONA.COM.


; aqui pones los hosts
EOF

cat <<EOF >/var/lib/bind/192.168.0.rev
$ttl 3600
192.168.0.in-addr.arpa.  IN      SOA     ns.ZONA.COM. santi.ZONA.COM. (
                3            ; serial
                7200         ; refresh after 2 hours
                3600         ; retry after 1 hour
                604800       ; expire after 1 week
                86400 )      ; minimum TTL of 1 day
192.168.0.in-addr.arpa.  IN      NS      ns.ZONA.COM.
...
named-checkzone 192.168.0.in-addr.arpa /var/lib/bind/192.168.0.rev
